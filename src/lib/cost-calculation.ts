...
const CONTAINER_SIZE_COEF = {
  '20': 1.10,   // 20-футовые на 10% дороже
...
const CONTAINER_TYPE_COEF = {
  'DC': 1.00,
  'HC': 1.00,
  'REF': 1.15,   // Рефы на 15% дороже
  'OT': 1.08,    // Open Top на 8% дороже
  'FR': 1.12,    // Flat Rack на 12% дороже
};
...
export function getCurrentParams() {
  return {
    ...
    model: 'v8.0 с минимальной ставкой и убывающим тарифом',
  };
}
