...
// 5. Экспорт круговой: гружёный + порожний × 50%
// 6. Калужская область: +2%
// 7. Горные регионы (Северная Осетия) +30%
// 8. Округление до тысяч
// Обновлено: март 2026
// ============================================
...
export const REGIONAL_COEFFICIENTS: Record<string, number> = {
  ...
  // Калужская область (Ворсино, Обнинск)
  'kaluga': 1.02,
...
export function getCurrentParams() {
  return {
    ...
    model: 'v11.6 калиброванная (расхождение ≤3%)',
  };
}
