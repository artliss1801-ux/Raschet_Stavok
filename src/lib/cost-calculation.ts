...
// 5. Горные регионы (Северная Осетия) +25%
// Обновлено: март 2026
// ============================================
...
export const REGIONAL_COEFFICIENTS: Record<string, number> = {
  ...
  'north_ossetia': 1.25, // Владикавказ, Алагир, Беслан - горные условия
...
export function getCurrentParams() {
  return {
    ...
    model: 'v11.1 обученный на реальных данных марта 2026',
  };
}
