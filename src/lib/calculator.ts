...
//
// Ключевые изменения v11.2:
// - Точная калибровка по реальным ставкам (расхождение ≤1%)
// - Коэффициент Северной Осетии: 1.313 (подобран по данным)
// - Убрано округление до тысяч для повышения точности
